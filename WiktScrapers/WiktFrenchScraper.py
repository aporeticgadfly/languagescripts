...
parser = argparse.ArgumentParser(prog='WiktFrenchParser', description='scrapes wiktionary verb categories and outputs a list of all verbs in said category to a local txt file')
