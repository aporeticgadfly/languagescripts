...
parser = argparse.ArgumentParser(
    prog="SentenceWordMatcher",
    description="given a list of comma separated words and a list of comma separated english-target sentence pairs, finds first sentence pair containing each word and outputs to a csv file",
)
