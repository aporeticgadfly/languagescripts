...
parser = argparse.ArgumentParser(
    prog="EuroSentenceMiner", description="mines sentence pairs from europarl corpus"
)
...
def extract_sentence_pairs(english_corpus, other_corpus):
    ...
    sentence_pairs = [
        (english.strip(), other.strip())
        for english, other in zip(english_sentences, other_sentences)
    ]
